...
const MOVIES_LIST_ERROR_MSG =
  "При получении списка фильмов что-то пошло не так";
const MOVIES_SAVED_LIST_ERROR_MSG =
  "При получении списка сохраненных фильмов что-то пошло не так";
...
// фильмы
const HAVE_NO_MOVIE_MSG =
  "У вас нет сохраненных фильмов. Подберите что-нибудь интересное на странице Фильмы";
const SEARCH_MOVIE_ERROR_MSG =
  "Среди фильмов нет ни одного соответствующего вашему запросу";

// короткометражки
const HAVE_NO_SHORTMOVIE_MSG =
  "У вас нет сохраненных короткометражек. Подберите что-нибудь интересное на странице Фильмы";
const SEARCH_SHORTMOVIE_ERROR_MSG =
  "Среди короткометражек нет соответствующих вашему запросу";

// InfoTooltip
const PROFILE_UPDATED_MSG = "Профиль успешно обновлён!";
const SOMETHING_WENT_WRONG_MSG = "Что-то пошло не так! Попробуйте еще раз";
const REQUEST_ERROR_MSG =
...
// Форматирование отображения карточек
const getInitialElements = () => {
  if (window.innerWidth > 1100) return 12;
  if (window.innerWidth > 840) return 12;
  if (window.innerWidth > 540) return 8;
  return 5;
};

const getElementsToAdd = () => {
